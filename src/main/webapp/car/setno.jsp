            ...
            <fieldset>
				...
				<div>
                	<iframe id="gmframe" width="360" height="240" frameborder="0" scrolling="no" marginheight="0"
                    		marginwidth="0" src="https://maps.google.com/?output=embed&amp;q=<%=trashcarrecord.getUserlat()%>,<%=trashcarrecord.getUserlng()%>">
                    </iframe>
                    <br><br>
                	<input type="hidden" name="lat" id="lat" value="<%=trashcarrecord.getUserlat()%>">
               		<input type="hidden" name="lng" id="lng" value="<%=trashcarrecord.getUserlng()%>">    
                </div>
				...
				%>
                	...
                	<label for="gt1" id="lgt1" class="labels">預計抵達時間:<span id="pgt1"><%=time1%></span></label>
	                <iframe id="gt1frame" width="360" height="240" frameborder="0" scrolling="no" marginheight="0"
	                    	marginwidth="0" src="https://maps.google.com/?output=embed&amp;q=<%=trashcarrecord.getRelat1()%>,<%=trashcarrecord.getRelng1()%>">
	                </iframe>
